...
document.querySelector('[data-action="sign-in"]')?.addEventListener('click', async () => {
...
document.querySelector<HTMLFormElement>('[data-onboarding]')?.addEventListener('submit', async (event) => {
...
document.querySelector<HTMLFormElement>('[data-link]')?.addEventListener('submit', async (event) => {
  event.preventDefault();
...
document.querySelector<HTMLFormElement>('[data-consent]')?.addEventListener('submit', async (event) => {
  event.preventDefault();
  const accept =

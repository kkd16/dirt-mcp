...
final class RegionGeometry {
    ...
    static NormalizedRegion normalize(BlockPosition first, BlockPosition second, long maxVolume)
            throws RegionTooLargeException {
        BlockPosition min =
                new BlockPosition(
    ...
    record NormalizedRegion(
            BlockPosition min, BlockPosition max, Dimensions dimensions, long volume) {}

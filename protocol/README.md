...
bounded inspection, FAWE-backed cuboid and palette-based edits, in-memory undo,
and ordered operator-level command dispatch. Unimplemented operations are not
included.
